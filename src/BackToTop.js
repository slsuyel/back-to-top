...
const BackToTop = () => {
    ...
    return (react_1.default.createElement("div", { className: "progress-wrap active-progress", style: visibilityStyle, onClick: handleBackToTop },
        react_1.default.createElement("svg", { className: "progress-circle svg-content", width: "100%", height: "100%", viewBox: "-1 -1 102 102", fill: "none" },
